...
public class DBService {
    ...
    public void instanciaDB() {
        ...
        Tecnico t4 = new Tecnico(null, "Katarina Ferreira", "612.261.820-97","tataferreira@gmail.com", ("123456"));
        t4.addPerfis(Perfil.TECNICO);
        Tecnico t5 = new Tecnico(null, "Yaslane Souza", "936.848.410-48","dandansouza@gmail.com", ("123456"));
        t5.addPerfis(Perfil.TECNICO);
        t5.addPerfis(Perfil.ADMIN);
        Tecnico t6 = new Tecnico(null, "Brenda Souza", "820.420.380-24","souzabrubs@gmail.com", ("123456"));
